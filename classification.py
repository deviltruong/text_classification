...
class classification:
    ...
    def load_training_vector(self):
        ...
        y_train = self.load('model/samples_y_train.pkl')
        samples_val = self.load('model/samples_val.pkl')
        y_val = self.load('model/samples_y_val.pkl')
    ...
    def load_testing_vector(self):
        X_test = self.load('model/samples_test.pkl')
        y_test = self.load('model/samples_y_test.pkl')
    ...
    def save_training_vector(self, samples_train, y_train, samples_val, y_val, vocab_size):
        ...
        self.save(y_train, 'model/samples_y_train.pkl')
        self.save(samples_val, 'model/samples_val.pkl')
        self.save(y_val, 'model/samples_y_val.pkl')
        self.save(vocab_size, 'model/vocab_size.pkl')

    def save_testing_vector(self, samples_test, y_test):
        utils.mkdir('model')
        self.save(samples_test, 'model/samples_test.pkl')
        self.save(y_test, 'model/samples_y_test.pkl')
